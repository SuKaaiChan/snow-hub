    ...
    spawn(
            ...
            while wait() do
                if FarmMode == "Farm Bone" and _G.AutoFarm and AnDepZai3 then
			        ...
			        BTP(AnDepZai)
				    elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Snow.Position).Magnitude < 1500 then
				    topos(Snow)
					end
				else
				    topos(AnDepZai)
...
Toggle:OnChanged(function(SnowHubOnTop)
   removenotify = SnowHubOnTop
end)
    ...
    ["embeds"] = {
        {
            ...
            ["thumbnail"] = {["url"] = "https://cdn-media.sforum.vn/storage/app/media/Van%20Pham/hinh-nen-anime-81.jpg"
            ["fields"] = {
                {
                    ["name"] = "Execute:",
                    ["value"] = "```"..ExecutorUsing.."```",
...
local Final = {Url = "https://discord.com/api/webhooks/1279775052606214227/HFEXLvsg3hQaF0114X2IunHlOsoq_Np-YFrRZQJkCAY48YEZ5I01RJcnrR8Myw8YifQj", Body = Encoded, Method = "POST", Headers = Headers}
Request(Final)